...
import { Lock, Mail, Eye, EyeOff, ArrowLeft, Loader2, User } from "lucide-react"
...
export default function SignupPage() {
  ...
  const { signup, isAuthenticated, checkAuth, isLoading: authLoading } = useCustomerAuth()
        ...
        >
          ...
          <div className="mb-10">
            ...
            <p className="text-sm text-muted-foreground mt-3">
              Save your favorites, track orders, and checkout faster
            </p>
          </div>
